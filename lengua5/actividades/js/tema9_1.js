  ...
  function Inicio() {
    ...
    function Resp1(){
        ...
        for(var i=1; i<16; i++){
            if( i<6 ){
                if($('#lSN'+(i) +'.pinta').text()){
                  notaFinalP1++;
                  $('#lSN'+i).css("background-color", "#5ED188");
                }/*else{
                  $('#lSN'+i).css("background-color", "#EF87A7");
                }*/
            }else{
                if($('#lSN'+(i) +'.pinta').text()){
                  notaFinalP1--;
    ...
    $(".panel-collapse").removeClass('in');
      ...
      Preg1();
          ...
          for(var i=1; i<16; i++){////Preg1

              $('#lSN'+(i)).click(function(){
      ...
      function confirmar() {
        ...
        var notaFinal;
        if( notaFinalP1 < 0 ){ notaFinal = 0}else{ notaFinal = ((notaFinalP1*2)).toFixed(2)}

...
var resp_cor_len3_act13_p14 = {
    inicio: ["narra la historia de unos personajes.", "img/i1_p29_act39.png"],
    desarrollo: ["cuenta cómo son los objetos o animales.", "img/i2_p29_act39.png"],
    final: ["explica de forma objetiva los hechos.", "img/i3_p29_act39.png"]
}
var cajas = document.getElementsByClassName('cajas');
var loadImg = ['img/i1_p29_act39.png', 'img/i2_p29_act39.png', 'img/i3_p29_act39.png'];
var loadTxt = ['explica de forma objetiva los hechos.', 'narra la historia de unos personajes.', 'cuenta cómo son los objetos o animales.'];

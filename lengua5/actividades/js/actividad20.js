...
var resp_cor_len3_act10_p13 = {
    0: ["caja_txt1", "img/i4_p19_act20.png"],
    1: ["caja_txt2", "img/i2_p19_act20.png"],
    2: ["caja_txt3", "img/i1_p19_act20.png"],
    3: ["caja_txt4", "img/i3_p19_act20.png"],
    4: ["caja_txt5", "img/i5_p19_act20.png"]
}
var cajas = document.getElementsByClassName('cajas');
var loadImg = ['img/i1_p19_act20.png', 'img/i2_p19_act20.png', 'img/i3_p19_act20.png', 'img/i4_p19_act20.png', 'img/i5_p19_act20.png'];
var loadTxt = ['caja_txt1', 'caja_txt2', 'caja_txt3', 'caja_txt4', 'caja_txt5'];
...
function contarRespCorrectaDnD() {
    ...
    for (i = 0; i < arrayCorrestarColorear.length; i++) {
        var id = document.getElementsByClassName(arrayCorrestarColorear[i]);

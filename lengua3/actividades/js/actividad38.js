...
var resp_cor_len3_act16 = {
    0:['caja_txt1','Título'],
    1:['caja_txt2','Destinario'],
    2:['caja_txt3','Mensaje'],
    3:['caja_txt4','Imagen'],
    4:['caja_txt5','Remitente (firma)']
}
...
var loadTxt = ['Título','Imagen','Destinario',
'Mensaje',
'Remitente (firma)'
];  
var divs = $(".td, .texto");
...
function enviarEventosListener(id,id2)
{
    ...
    document.getElementById(id2).addEventListener('dragover',function(){
        dragOver(id2);
    });
    document.getElementById(id2).addEventListener('dragleave',function(){
        dragLeave(id2);
    });

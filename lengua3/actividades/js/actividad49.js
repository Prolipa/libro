...
var loadValues = {
    ...
    text : {
        0 : ['Hoy','tarjeta','una','haré','para','abuelita.','mi'],
        1 : ['mi','una','en','Expreso','cariño','tarjeta.'],
        2 : ['una','Me','entregaron','tarjeta.'],
        3 : ['un','mensaje','Escribo','amistad.','de']
    },
...
var respuestasCorrectas={
    0:  ['Hoy', 'haré', 'una', 'tarjeta', 'para', 'mi', 'abuelita.'],
    1:  ['Expreso', 'mi', 'cariño', 'en', 'una', 'tarjeta.'],
    2:  ['Me', 'entregaron', 'una', 'tarjeta.'],
    3:  ['Escribo', 'un', 'mensaje', 'de', 'amistad.']
};

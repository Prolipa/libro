...
(function(document, $, wordfind) {
    ...
    var WordFindGame = function() {
        ...
        var drawWords = function(el, words) {
            var imgs = ['i1_p181_u5a25.jpg', 'i2_p181_u5a25.jpg', 'i3_p181_u5a25.jpg', 'i4_p181_u5a25.jpg', 'i5_p181_u5a25.jpg', 'i6_p181_u5a25.jpg'];
            var output = '<ul>';
            for (var i = 0, len = words.length; i < len; i++) {
                var word = words[i];
                var img = imgs[i];
                output += '<li class="word ' + word + '"><img src="img/' + img + '" alt="' + img + '" class="img-responsive">' + word+'</li>';
            }
            output += '</ul>';

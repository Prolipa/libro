...
document.getElementById('nt1_3').addEventListener('keyup', () => {
    validMaxIngreso(document.getElementById('nt1_3'), 2)
});
document.getElementById('nt1_4').addEventListener('keypress', () => {
    validNumero(0, 2, 1);
});
document.getElementById('nt1_4').addEventListener('keyup', () => {
    validMaxIngreso(document.getElementById('nt1_4'), 2)
});
...
function resolverN57() {
    ...
    var nota4 = document.getElementById("nt1_3").value;
    if ((nota1 == "") || (nota2 == "") || (nota3 == "") || (nota4 == "")) {
        ...
        if ((nota1 <= 10) && (nota2 <= 10) && (nota3 <= 10) && (nota4 <= 10)) {
            ...
            document.getElementById("nt1_4").style.backgroundColor = "#6DFF6F";
            ...
            document.getElementById('nt1_4').disabled = true;
        }
    }
}

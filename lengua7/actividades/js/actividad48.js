document.getElementById('nt47_1').addEventListener('keypress', () => {
    validNumero(0, 2, 1);
});
document.getElementById('nt47_1').addEventListener('keyup', () => {
    validMaxIngreso(document.getElementById('nt47_1'), 2)
});
document.getElementById('nt47_2').addEventListener('keypress', () => {
    validNumero(0, 4, 1);
});
document.getElementById('nt47_2').addEventListener('keyup', () => {
    validMaxIngreso(document.getElementById('nt47_2'), 4)
});
document.getElementById('nt47_3').addEventListener('keypress', () => {
    validNumero(0, 4, 1);
});
document.getElementById('nt47_3').addEventListener('keyup', () => {
    validMaxIngreso(document.getElementById('nt47_3'), 4)
});

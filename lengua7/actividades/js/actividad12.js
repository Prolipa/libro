...
var resp_cor_len3_act13_p14 = {
    inicio: ["Saludo", "img/i1_p11_act12.png"],
    desarrollo: ["Presentación del objeto", "img/i2_p11_act12.png"],
    final: ["Descripción detallada del objeto", "img/i3_p11_act12.png"],
    final2: ["Opinión personal", "img/i4_p11_act12.png"],

}
var cajas = document.getElementsByClassName('cajas');
var loadImg = ['img/i1_p11_act12.png', 'img/i2_p11_act12.png', 'img/i3_p11_act12.png', 'img/i4_p11_act12.png'];
var loadTxt = ['Saludo', 'Presentación del objeto', 'Descripción detallada del objeto', 'Opinión personal'];

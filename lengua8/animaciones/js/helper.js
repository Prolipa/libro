...
$(document).ready(function () {
	...
	//ayuda
	var ayuda = 'Para repetir el ejercicio pulsa sobre <span class="glyphicon glyphicon-refresh" aria-hidden="true"></span>'+
...
function cerrar_alerta() {
    $('.nota-abierta').removeClass('no-valid')
    $("#nota-alerta").hide("blind", {direction: 'up'}, 500);
}

function mostrar_alerta(mensaje) {
    $("#nota-alerta-msj").html(mensaje)
    $("#nota-alerta").show("blind", {direction: 'up'}, 500)
            .delay(2000)/*.hide("blind", {direction: 'up'}, 1000).delay(3000)*/
}

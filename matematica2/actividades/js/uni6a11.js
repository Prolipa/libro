...
document.getElementById("pr1a").addEventListener("keypress", () => {
    validNumero(0, 1, 1);
});
document.getElementById("pr1a").addEventListener("keyup", () => {
    validMaxIngreso(document.getElementById("pr1a"), 4);
});

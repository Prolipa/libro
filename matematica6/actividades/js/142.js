...
function cojerdatos(nombre,vct){
 ...
 $("#Calificar").click(function(){
    nota = 0;
    ra=["circunferencia", "radio", "centro", "círculo", "cuerda", "diámetro", "secante", "arco", "diámetro", "dos radios", "tangente", "cuerda", "un segmento recto", "ser medido", "arco", "diámetro", "centro", "diámetro", "radio"];
    nombre="a";
    vra=[];
    for(i=0;i<19;i++){

...
function Cargar() {
    ...
    NumerosAleatorios($cantidad);
        ...
        document.datos.num5.value = myArray[3];
        document.datos.num6.value = myArray[4];
        ...
        $cont4=Divisor(myArray[3],vct4,contenido3,$cont4,$id4);
        $cont5=Divisor(myArray[4],vct5,contenido4,$cont5,$id5);
...
$(document).ready(function() {
    ...
    $("#Calificar").click(function() {
        ...
        calificarf($cont4,vtcrd,$id4);
        calificarf($cont5,vtcre,$id5);

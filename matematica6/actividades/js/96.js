...
function Cargar(){
    ...
    for(i=1;i<=10;i++){
        p1[i]='<tr><td class="danger"><label>'+i+'</label></td><td><input type="number" class="cajaa" id="a'+i+'"><sup><input type="number" class="cajab" id="b'+i+'"></sup></td><td><input type="number" class="cajaa" id="c'+i+'">X<input type="number" class="cajaa" id="d'+i+'"></td><td><input type="number" class="cajac" id="e'+i+'"></td></tr>';

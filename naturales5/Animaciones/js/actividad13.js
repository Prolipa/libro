...
var resp_cor_len3_act13_p14 = {
    inicio : ["se presentan los personajes y los lugares o escenarios donde se desarrollará el cuento.","img/i1_p14_act13.png"],
    desarrollo : ["se presenta el conflicto o problema que los protagonistas deberán resolver.","img/i2_p14_act13.png"],
    final : ["se resuelve el conflicto.","img/i3_p14_act13.png"] 
}
var cajas = document.getElementsByClassName('cajas');
var loadImg = ['img/i1_p14_act13.png','img/i2_p14_act13.png','img/i3_p14_act13.png'];
var loadTxt = ['Se resuelve el conflicto.','Se presentan los personajes y los lugares o escenarios donde se desarrollará el cuento.','Se presenta el conflicto o problema que los protagonistas deberán resolver.'];

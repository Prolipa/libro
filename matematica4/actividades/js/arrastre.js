var ejer=1,itemsT=(16 *ejer),cont=0,tmp,cor=0,inc=0,calificacion=10,claseAnimada='animate bounceIn';
var r_images=[],t_images=[],v_ids=[],r_ids=[],r_cono=[],r_cilindro=[],r_circulo=[],r_prisma=[],r_cubo=[],n_cono=2,n_cilindro=4,n_circulo=5,n_prisma=2,n_cubo=3;
f_cargar();
function f_cargar(){
    for(i=1;i<17;i++){
        if(i<3){

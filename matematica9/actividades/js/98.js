var titulos="evaluacion";
  function Inicio() {
    ...
    function Preg1(){
        ...
        for(var i=0; i<4; i++){          
          ...
          var op = ['57 000 000 x 32 000','0.00067 x 0. 0047','0. 00043<sup>2</sup>  x 0. 0096<sup>2</sup>','76 000 000<sup>2</sup>  x  46 000 <sup>3</sup>'];
 ...
 /* function Preg7(){
    ...
    function Resp1(){
         ...
         var resp = ['1.82x10^12','3.149x10^-6','1.70x10^-9','5.62x​10^29'];
    ...
    function Resp4(){
            ...
            if( $('#rDNM0').val() == '>' ){
                notaFinalP4++;
                $('#rDNM0').css("background-color", "#5ED188");
            }else{
                $('#rDNM0').css("background-color", "#EF87A7");
            }
    ...
    function Resp5(){
            ...
            for(var i=0; i<3; i++){
                ...
                if( parseInt(($('#rCPC'+i).val())) == resp[i] ){
                    notaFinalP5++;
                    $('#rCPC'+i).css("background-color", "#5ED188");
                }else{
                    $('#rCPC'+i).css("background-color", "#EF87A7");
                }
    ...
    function Resp9(){
      ...
      82.5,11,50,22,100];
            ...
            for(var i=0; i<35; i++){
                ...
                if( parseFloat(($('#rGEE'+i).val())) == resp[i] ){
                    notaFinalP9++;
                    $('#rGEE'+i).css("background-color", "#5ED188");
                }else{
                    $('#rGEE'+i).css("background-color", "#EF87A7");
                }
    ...
    $(".panel-collapse").removeClass('in');
      ...
      function confirmar() {
        ...
        var nota5 = (notaFinalP5)/3;
        var nota6 = (notaFinalP6);
        var nota7 = (notaFinalP7)/3;
        var nota8 = (notaFinalP8)/6;
        var nota9 = (notaFinalP9)/35;
        var nota10 = parseFloat($('#calificacion1').val());

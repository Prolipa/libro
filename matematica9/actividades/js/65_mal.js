...
$(document).ready(function() {
    ...
    function datos(i) {
        ...
        if ($("#nota3").text() == "0.00") {
            alertify.prompt("Introducir notas para la pregunta 3 sobre 1:", function(e, str3) {
                if (e) {
                    if (str3 == "1") {
                        str3 = "1.00";
                    }
        ...
        if ($("#nota4").text() == "0.00") {
            alertify.prompt("Introducir notas para la pregunta 4 sobre 1:", function(e, str4) {
                if (e) {
                    if (str4 == "1") {
                        str4 = "1.00";
                    }
        ...
        if ($("#nota5").text() == "0.00") {
            alertify.prompt("Introducir notas para la pregunta 5 sobre 1:", function(e, str5) {
                if (e) {
                    if (str5 == "1") {
                        str5 = "1.00";
                    }
        ...
        if ($("#nota6").text() == "0.00") {
            alertify.prompt("Introducir notas para la pregunta 6 sobre 1:", function(e, str6) {
                if (e) {
                    if (str6 == "1") {
                        str6 = "1.00";
                    }
                    alertify.success("Has pulsado has introducido nota: " + str6);
                    $("#nota6").text(str6);
                    console.log("nota6" + str6);
                    datos(4)
                } else {
                    alertify.error("No has ingresado la nota");
                    datos(4);
        ...
        if ($("#nota7").text() == "0.00") {
            alertify.prompt("Introducir notas para la pregunta 7 sobre 1:", function(e, str7) {
                if (e) {
                    if (str7 == "1") {
                        str7 = "1.00";
                    }
                    alertify.success("Has pulsado has introducido nota: " + str7);
                    $("#nota7").text(str7);
                    console.log("nota7" + str7);
                    datos(4)
                } else {
                    alertify.error("No has ingresado la nota");
                    datos(4);
    ...
    function confirmar() {
        if ($("#nota1").val() == "0.00" || $("#nota2").val() == "0.00" || $("#nota3").val() == "0.00"
            || $("#nota4").val() == "0.00" || $("#nota5").val() == "0.00" || $("#nota6").val() == "0.00"
            || $("#nota7").val() == "0.00") {
            datos(1);
        } else {
            alertify.confirm("<h3>Desea calificar la evaluación?</h3>", function(e) {
                if (e) {
                    ...
                    var notaFinal = 0;
                    for(var j=0;j<=2;j++){
                        notas8f = notas8f+notas8[j];
                        notas8f = notas8f/3;
                    }
                    $("#nota8").text(notas8f.toFixed(2));
                    for (var i = 1; i <= 8; i++) {

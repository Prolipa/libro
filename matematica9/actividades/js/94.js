var titulos="aplico";
  function Inicio() {
    ...
    function Resp1(){
         ...
         var resp = [365,18,6570,375,48,11250,385,92,16940,395,100,3160,100,37920,379.20,380.5,382.8];

            for(var i=0; i<17; i++){             
                if( (($('#rCSB'+i).val())) == resp[i] ){
                    notaFinalP1++;
                    $('#rCSB'+i).css("background-color", "#5ED188");
                }else{
                    $('#rCSB'+i).css("background-color", "#EF87A7");
                }

  ...
  $(document).ready(function() {
      ...
      $("#Calificar").click(function() {
          ...
          for (var i = 0; i <= 7; i++) {
              ...
              if (i == 0) {
                  if (res3[i] == "V") {
                      if (res1[i] == "V" && res2[i] == "V" && res4[i] == "F" && res5[i] == "F" && res6[i] == "V") {
                          nota = nota + 1;
              ...
              if (i == 2) {
                  if (res3[i] == "V") {
                      if (res1[i] == "V" && res2[i] == "V" && res4[i] == "V" && res5[i] == "V" && res6[i] == "V") {
                          nota = nota + 1;
                          $('#a' + i).css("background-color", "green");
                          $('#b' + i).css("background-color", "green");
                          $('#c' + i).css("background-color", "green");
              ...
              if (i == 3) {
                  if (res3[i] == "V") {
                      if (res1[i] == "F" && res2[i] == "F" && res4[i] == "V" && res5[i] == "V" && res6[i] == "F") {
                          nota = nota + 1;
                          $('#a' + i).css("background-color", "green");
                          $('#b' + i).css("background-color", "green");
                          $('#c' + i).css("background-color", "green");
              ...
              if (i == 6) {
                  if (res3[i] == "V") {
                      if (res1[i] == "V" && res2[i] == "V" && res4[i] == "V" && res5[i] == "F" && res6[i] == "V") {
                          nota = nota + 1;
                          $('#a' + i).css("background-color", "green");
                          $('#b' + i).css("background-color", "green");
                          $('#c' + i).css("background-color", "green");
              ...
              if (i == 7) {
                  if (res3[i] == "V") {
                      if (res1[i] == "F" && res2[i] == "V" && res4[i] == "V" && res5[i] == "F" && res6[i] == "V") {
                          nota = nota + 1;
                          $('#a' + i).css("background-color", "green");
                          $('#b' + i).css("background-color", "green");
                          $('#c' + i).css("background-color", "green");

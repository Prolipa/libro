  ...
  function Inicio() {
      ...
      for (var i = 0; i <= 7; i++) {
          ...
          opcionesD[i] = '<select required="required" class="form-control" name="servicio" id="d' + i + '">' +
              ...
              '<option value="V">V</option>' +
              '</select>';
          opcionesE[i] = '<select required="required" class="form-control" name="servicio" id="d' + i + '">' +
              '<option value="0" selected="selected">Seleccione una opción</option>' +
              '<option value="F">F</option>' +
              '<option value="V">V</option>' +
              '</select>';
  ...
  $(document).ready(function() {
      ...
      $("#Calificar").click(function() {
          ...
          for (var i = 0; i <= 7; i++) {
              ...
              if (i == 1) {
                  if (res3[i] == "V") {
                      if (res1[i] == "F" && res2[i] == "V" && res3[i] == "F" && res4[i] == "F") {
                          nota = nota + 1;
                          $('#a' + i).css("background-color", "green");
                          $('#b' + i).css("background-color", "green");
                          $('#c' + i).css("background-color", "green");
              ...
              if (i == 3) {
                  if (res3[i] == "F") {
                      if (res1[i] == "F" && res2[i] == "F" && res3[i] == "V" && res4[i] == "F") {
                          nota = nota + 1;
                          $('#a' + i).css("background-color", "green");
                          $('#b' + i).css("background-color", "green");
                          $('#c' + i).css("background-color", "green");
              ...
              if (i == 4) {
                  if (res3[i] == "V") {
                      if (res1[i] == "V" && res2[i] == "V" && res3[i] == "V" && res4[i] == "V") {
                          nota = nota + 1;
                          $('#a' + i).css("background-color", "green");
                          $('#b' + i).css("background-color", "green");
                          $('#c' + i).css("background-color", "green");
              ...
              if (i == 5) {
                  if (res3[i] == "V") {
                      if (res1[i] == "F" && res2[i] == "V" && res3[i] == "F" && res4[i] == "V") {
                          nota = nota + 1;
                          $('#a' + i).css("background-color", "green");
                          $('#b' + i).css("background-color", "green");
                          $('#c' + i).css("background-color", "green");

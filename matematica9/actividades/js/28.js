  ...
  function Inicio() {
      ...
      for (var i = 0; i <= 3; i++) {
          $("#contenido").append('<tr><td><label>' + valoresA[i] + '</label></td><td><label>' + valoresB[i] + '</label></td><td style="text-align:center"><select required="required" class="form-control" name="servicio" id="a' + i + '"><option value="0" selected="selected">Seleccione una opción</option><option value="F">F</option><option value="V">V</option></select></td><td style="text-align:center"><select required="required" class="form-control" name="servicio" id="b' + i + '"><option value="0" selected="selected">Seleccione una opción</option><option value="F">F</option><option value="V">V</option></select></td><td style="text-align:center">' + '<select required="required" class="form-control" name="servicio" id="c' + i + '"><option value="0" selected="selected">Seleccione una opción</option><option value="F">F</option><option value="V">V</option></select>' + '</td><td style="text-align:center">' + '<select required="required" class="form-control" name="servicio" id="d' + i + '"><option value="0" selected="selected">Seleccione una opción</option><option value="F">F</option><option value="V">V</option></select>' + '</td></tr>');
      }

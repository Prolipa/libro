  ...
  function Inicio() {
      ...
      for (var i = 0; i <= 7; i++) {
          ...
          opcionesF[i] = '<select required="required" class="form-control" name="servicio" id="f' + i + '">' +
              ...
              '<option value="V">V</option>' +
              '</select>';
          opcionesG[i] = '<select required="required" class="form-control" name="servicio" id="g' + i + '">' +
              '<option value="0" selected="selected">Opciones</option>' +
              '<option value="F">F</option>' +
              '<option value="V">V</option>' +
              '</select>';        
  ...
  $(document).ready(function() {
      ...
      $("#Calificar").click(function() {
          ...
          res7[0] = $("#g0 option:selected").text();
          res7[1] = $("#g1 option:selected").text();
          res7[2] = $("#g2 option:selected").text();
          res7[3] = $("#g3 option:selected").text();
          res7[4] = $("#g4 option:selected").text();
          res7[5] = $("#g5 option:selected").text();
          res7[6] = $("#g6 option:selected").text();
          res7[7] = $("#g7 option:selected").text();
          debugger;
          conta = 0;
          for (var i = 0; i <= 7; i++) {
              ...
              if (i == 0) {
                  if (res7[i] == "V") {
                      if (res1[i] == "V" && res2[i] == "V" && res3[i] == "V" && res4[i] == "F" && res5[i] == "F" && res6[i] == "V") {
                          nota = nota + 1;
              ...
              if (i == 1) {
                  if (res7[i] == "V") {
                      if (res1[i] == "V" && res2[i] == "V" && res3[i] == "F" && res4[i] == "F" && res5[i] == "F" && res6[i] == "F") {
                          nota = nota + 1;
                          $('#a' + i).css("background-color", "green");
                          $('#b' + i).css("background-color", "green");
                          $('#c' + i).css("background-color", "green");
              ...
              if (i == 2) {
                  if (res7[i] == "V") {
                      if (res1[i] == "V" && res2[i] == "F" && res3[i] == "V" && res4[i] == "V" && res5[i] == "V" && res6[i] == "V") {
                          nota = nota + 1;
                          $('#a' + i).css("background-color", "green");
                          $('#b' + i).css("background-color", "green");
                          $('#c' + i).css("background-color", "green");
              ...
              if (i == 3) {
                  if (res7[i] == "V") {
                      if (res1[i] == "V" && res2[i] == "F" && res3[i] == "F" && res4[i] == "V" && res5[i] == "V" && res6[i] == "V") {
                          nota = nota + 1;
                          $('#a' + i).css("background-color", "green");
                          $('#b' + i).css("background-color", "green");
                          $('#c' + i).css("background-color", "green");
              ...
              if (i == 5) {
                  if (res7[i] == "V") {
                      if (res1[i] == "F" && res2[i] == "V" && res3[i] == "F" && res4[i] == "F" && res5[i] == "F" && res6[i] == "V") {
                          nota = nota + 1;
                          $('#a' + i).css("background-color", "green");
                          $('#b' + i).css("background-color", "green");
                          $('#c' + i).css("background-color", "green");
              ...
              if (i == 6) {
                  if (res7[i] == "V") {
                      if (res1[i] == "F" && res2[i] == "F" && res3[i] == "V" && res4[i] == "V" && res5[i] == "F" && res6[i] == "V") {
                          nota = nota + 1;
                          $('#a' + i).css("background-color", "green");
                          $('#b' + i).css("background-color", "green");
                          $('#c' + i).css("background-color", "green");
              ...
              if (i == 7) {
                  if (res7[i] == "V") {
                      if (res1[i] == "F" && res2[i] == "F" && res3[i] == "F" && res4[i] == "V" && res5[i] == "F" && res6[i] == "V") {
                          nota = nota + 1;
                          $('#a' + i).css("background-color", "green");
                          $('#b' + i).css("background-color", "green");
                          $('#c' + i).css("background-color", "green");
          ...
          if (($("#Respuesta").val()).toLowerCase() == "tautología") {
              nota = nota + 1;

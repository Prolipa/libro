...
function f_iniciar() {
    ...
    for (i = 0; i < n1; i++) {
        img1 = ("<img src='img/i2_p19_act9.png' style='position:absolute;top:" + y1 + "px;left: 36px'>");
        y1 -= decr;
        $(".c_piezas").append(img1);
    }
    for (i = 0; i < n2; i++) {
        img2 = ("<img src='img/i3_p19_act9.png' style='position:absolute;top:" + y2 + "px;left: 77px'>");
        y2 -= decr;

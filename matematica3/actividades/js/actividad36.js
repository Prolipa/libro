...
function f_iniciar() {
    ...
    $(".tt1, .s1").each(function(index) {
        $(this).html(i_nums[index]); //respuestas
    });
    //carga de imagenes
    ...
    function f_suma() {
        ...
        nrB = n3 + n4;
        // i_nums.push(1,String(n1),String(n3),String(n2),1,String(n4));
        i_nums.push(1, n1, n3, n2, n4, 1) //incluyo el numero 1, par los 2 subindices
        if (nrA < 10 && nrB > 9) {
            resp.push(nrA, String(nrB)[1]); //incluyo el numero 1, par los 2 subindices
        } else {
            f_suma();
        }
    }

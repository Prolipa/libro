var bg_r=0,n1=0,n2=0,n3=0,n4=0,nrA=0,nrB=0,ejer=10,cont=0,itemsT=2*ejer,tmp,cor=0,inc=0,calificacion=10,resp=[],i_nums=[],tmp_res=[],signos=['+','-'],str=0;
...
function f_iniciar(){
    ...
    function f_resta(){
        ...
        if(nrA>0 && nrB>0){
            resp.push(n1,n3,' ',signos[0],' ',n2,n4);
            i_nums.push(n1,n3,n2,n4);//impresion de numeros en tabla
        }else{
            f_resta();
        }                    
    }

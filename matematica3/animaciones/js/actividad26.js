...
function f_iniciar(){
   ...
   function f_suma(){
    ...
    function f_barras(){
        ...
        for(i=0;i<n1;i++){
            img1=("<img src='img/i1_p19_act3.png' class='pull-left img-responsive'>");
            $(".barras").append(img1);
            $(".barras").addClass( "animate fadeIn" );//agregamos clase de animacion
        }
        for(i=0;i<n3;i++){
            img1=("<img src='img/i1_p29_act1.png' class='img-responsive'>");
            $(".cuadros").append(img1);
            $(".cuadros").addClass( "animate fadeIn" );//agregamos clase de animacion
        }
        for(i=0;i<n2;i++){
            img1=("<img src='img/i1_p19_act3.png' class='pull-left img-responsive'>");
            $(".barras1").append(img1);
            $(".barras1").addClass( "animate fadeIn" );//agregamos clase de animacion
        }
        for(i=0;i<n4;i++){
            img1=("<img src='img/i1_p29_act1.png' class='img-responsive'>");
            $(".cuadros1").append(img1);
            $(".cuadros1").addClass( "animate fadeIn" );//agregamos clase de animacion
        }
        console.log(resp);
    }
    function f_abaco(){
        ...
        for(i=0;i<n1;i++){
            ...
            $(".c_piezas1").addClass( "animate fadeIn" );//agregamos clase de animacion
        ...
        for(i=0;i<n2;i++){
            img1=("<img src='img/i2_p19_act2.png' style='position:absolute;top:"+y3+"px;left: 51px'>");
            y3-=decr1;
            $(".c_piezas2").append(img1);
            $(".c_piezas2").addClass( "animate fadeIn" );//agregamos clase de animacion
            //$(".c_piezas").addClass( "animate fadeIn" );//agregamos clase de animacion
        }
        for(i=0;i<n4;i++){
            img2=("<img src='img/i3_p19_act2.png' style='position:absolute;top:"+y4+"px;left: 92px'>");
            y4-=decr1;

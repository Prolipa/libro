var i,j,nums=[],r_images=[],t_images=[],v_ids=[],r_ids=[],cont=0,ejer=5,cor=0,inc=0,itemsT=3*ejer;calificacion=10;
var claseAnimada='animate bounceIn';
f_cargar();
function f_cargar(){
    for(i=1;i<10;i++){
        t_images.push("<img src='img/i"+i+"_p17_act1.png' class='c_imagenes' id='r"+i+"'>");
    }
    f_iniciar();
}
function f_iniciar(){

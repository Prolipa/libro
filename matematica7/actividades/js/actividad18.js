var titulos = "aplico";
  ...
  $(document).ready(function() {
      ...
      $("#Calificar").click(function() {
          ...
          respuestas[3] = String(Math.pow(parseInt($("#base1").text()), 2)) + " unidades";
          respuestas[4] = String(Math.pow(parseInt($("#base2").text()), 2)) + " unidades";
          respuestas[5] = String(Math.pow(parseInt($("#base3").text()), 2)) + " unidades";

          if ($("#res1").val().toLowerCase() == respuestas[0]) {
              nota = nota + 1;
              band = 1;
          ...
          if ($("#res2").val().toLowerCase() == respuestas[1]) {
              nota = nota + 1;
              band = 1;
          ...
          if ($("#res3").val().toLowerCase() == respuestas[2]) {
              nota = nota + 1;
              band = 1;

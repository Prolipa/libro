var titulos ="preparo"
  function Inicio() {
      ...
      contenido1[0] = '<label>Patrón</label><input type="number" placeholder=0 id="patron1" class="patron"><input type="number" placeholder=0 id="patron2" class="patron">&nbsp;<label><strong>→</strong></label>&nbsp;' +
          '<label class="nuevo"><label id="numero1">' + (valoresA[0] + patron) + '</label>' +
          '&nbsp;<label>-</label>&nbsp;' +
          '<label id="numero2">' + (valoresA[0]) + '</label>' +
          '&nbsp;<label>=</label>&nbsp;' +
          '<input type="number" id="res1" placeholder=0 class="Respuesta"></label><label>;</label>' +
          '<label class="nuevo"><label id="numero3">' + (valoresA[1] + patron1) + '</label>' +
          '&nbsp;<label>-</label>&nbsp;' +
          '<label id="numero4">' + (valoresA[1]) + '</label>' +
          '&nbsp;<label>=</label>&nbsp;' +
          '<input type="number" id="res2" placeholder=0 class="Respuesta"></label><label>;</label>' +
          '<label class="nuevo"><label id="numero5">' + (valoresA[2] + patron) + '</label>' +
          '&nbsp;<label>-</label>&nbsp;' +
          '<label id="numero6">' + (valoresA[2]) + '</label>' +
          '&nbsp;<label>=</label>&nbsp;' +
          '<input type="number" id="res3" placeholder=0 class="Respuesta"></label><label>;</label>' +
          '<label class="nuevo"><label id="numero7">' + (valoresA[3] + patron1) + '</label>' +
          '&nbsp;<label>-</label>&nbsp;' +
          '<label id="numero8">' + (valoresA[3]) + '</label>' +
          '&nbsp;<label>=</label>&nbsp;' +
          '<input type="number" id="res4" placeholder=0 class="Respuesta"></label>;';
      suc[0] = valoresA[0];
      suc[1] = suc[0] + patron;
      suc[2] = suc[1] + patron1;
      suc[3] = suc[2] + patron;
      ...
      var sucesion = '<label>Sucesión</label>&nbsp;&nbsp;' +
          '<label class="suc">' + suc[0] + '</label>&nbsp;&nbsp;' +
          '<label class="suc">' + suc[1] + '</label>&nbsp;&nbsp;' +
          '<label class="suc">' + suc[2] + '</label>&nbsp;&nbsp;' +
          '<label class="suc" id="ini">' + suc[3] + '</label>&nbsp;&nbsp;' +
          '<input class="sucR"type="number" id="s1" class="rS">&nbsp;&nbsp;' +
          '<input class="sucR" type="number" id="s2" class="rS">&nbsp;&nbsp;' +
          '<input class="sucR" type="number" id="s3" class="rS">';

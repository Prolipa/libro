...
var titulos = "reflexiono";
 ...
 function Inicio() {
     ...
     for (var j = 0; j <= 5; j++) {
         ...
         $("#contenido" + j).append('<tr>' + respuestas + '<td><input type="number" id="res' + j + '"></td></tr><tr style="height: 20px;"></tr>');
     }
 };
 ...
 $(document).ready(function() {
     ...
     $("#Calificar").click(function() {
         ...
         var nota = 0;
         for (var i = 0; i <= 5; i++) {
             if ($("#res" + i).val() == Math.pow(parseInt(base[i]), parseInt(exponente[i]))) {
                 nota = nota + 1;

! function(t) { if ("object" == typeof exports && "undefined" != typeof module) module.exports = t();
    ...
    return function t(e, n, i) {
        ...
        23: [function(t, e, n) { var i, r, o, s, a, h, l, c, u, p, d, f, g, m, y, S, v, x, w, k, b, C, P; for (a = t("../reactGUI/React-shim"), u = t("./optionsStyles").defineOptionsStyle, c = t("../core/localization")._, h = [
                ...
                ].map(function(t) { var e, n; return e = t[0], n = t[1], { name: c(e), value: n } }), l = [
        ...
        32: [function(t, e, n) { "use strict"; var i = t("../reactGUI/React-shim"),
            ...
            t("../optionsStyles/font"), t("../optionsStyles/stroke-width"), t("../optionsStyles/line-options-and-stroke-width"), t("../optionsStyles/polygon-and-stroke-width"), t("../optionsStyles/null"); var d = i.createClass({ displayName: "CanvasContainer", shouldComponentUpdate: function() { return !1 }, render: function() { return i.createElement("div", { key: "literallycanvas", className: "lc-drawing with-gui" }) } }),
                f = i.createClass({ displayName: "LiterallyCanvas", getDefaultProps: function() { return p }, bindToModel: function() { var t = o(this.canvas);
                        this.props;
                        this.lc.bindToElement(t), "function" == typeof this.lc.opts.onInit && this.lc.opts.onInit(this.lc) }, componentWillMount: function() { var t = this;
                        this.lc || (this.props.lc ? this.lc = this.props.lc : this.lc = new u(this.props), this.toolButtonComponents = this.lc.opts.tools.map(function(e) { return c(new e(t.lc)) })) }, componentDidMount: function() { this.lc.isBound || this.bindToModel() }, componentWillUnmount: function() { this.lc && this.lc._teardown() }, render: function() { var t = this,
                            e = this.lc,
                            n = this.toolButtonComponents,
                            r = (this.props, this.lc.opts),
                            o = r.imageURLPrefix,
                            s = r.toolbarPosition,
                            c = { lc: e, toolButtonComponents: n, imageURLPrefix: o },
                            u = a({ "toolbar-at-top": "top" === s, "toolbar-at-bottom": "bottom" === s, "toolbar-hidden": "hidden" === s }); return i.createElement("div", { className: "literally " + u }, i.createElement(d, { ref: function(e) { return t.canvas = e } }), i.createElement(h, c), i.createElement(l, { lc: e, imageURLPrefix: o })) } });
            e.exports = f }, { "../core/LiterallyCanvas": 5, "../core/defaultOptions": 10, "../core/util": 19, "../optionsStyles/font": 23, "../optionsStyles/line-options-and-stroke-width": 24, "../optionsStyles/null": 25, "../optionsStyles/polygon-and-stroke-width": 27, "../optionsStyles/stroke-width": 29, "../reactGUI/React-shim": 35, "../reactGUI/ReactDOM-shim": 36, "./Options": 33, "./Picker": 34, "./createToolButton": 41 }],
        33: [function(t, e, n) { var i, r, o, s;
            r = t("./React-shim"), o = t("./createSetStateOnEventMixin"), s = t("../optionsStyles/optionsStyles").optionsStyles, i = r.createClass({ displayName: "Options", getState: function() { var t; return { style: null != (t = this.props.lc.tool) ? t.optionsStyle : void 0, tool: this.props.lc.tool } }, getInitialState: function() { return this.getState() }, mixins: [o("toolChange")], renderBody: function() { var t; return t = "" + this.state.style, s[t] && s[t]({ lc: this.props.lc, tool: this.state.tool, imageURLPrefix: this.props.imageURLPrefix }) }, render: function() { var t; return (t = r.DOM.div)({ className: "lc-options horz-toolbar" }, this.renderBody()) } }), e.exports = i }, { "../optionsStyles/optionsStyles": 26, "./React-shim": 35, "./createSetStateOnEventMixin": 40 }],
        34: [function(t, e, n) { var i, r, o, s, a, h, l, c;
            a = t("./React-shim"), i = a.createFactory(t("./ClearButton")), h = a.createFactory(t("./UndoRedoButtons")), l = a.createFactory(t("./ZoomButtons")), c = t("../core/localization")._, o = a.createFactory(t("./ColorWell")), r = a.createFactory(a.createClass({ displayName: "ColorPickers", render: function() { var t, e; return e = this.props.lc, (t = a.DOM.div)({ className: "lc-color-pickers" }, o({ lc: e, colorName: "primary", label: c("color de linea") }), o({ lc: e, colorName: "secondary", label: c("color de relleno") }), o({ lc: e, colorName: "background", label: c("bgd") })) } })), s = a.createClass({ displayName: "Picker", getInitialState: function() { return { selectedToolIndex: 0 } }, renderBody: function() { var t, e, n, o, s; return t = a.DOM.div, o = this.props, s = o.toolButtonComponents, n = o.lc, e = o.imageURLPrefix, t({ className: "lc-picker-contents" }, s.map(function(t) { return function(i, r) { return i({ lc: n, imageURLPrefix: e, key: r, isSelected: r === t.state.selectedToolIndex, onSelect: function(e) { return n.setTool(e), t.setState({ selectedToolIndex: r }) } }) } }(this)), s.length % 2 !== 0 ? t({ className: "toolbar-button thin-button disabled" }) : void 0, t({ style: { position: "absolute", bottom: 0, left: 0, right: 0 } }, r({ lc: this.props.lc }), h({ lc: n, imageURLPrefix: e }), l({ lc: n, imageURLPrefix: e }), i({ lc: n }))) }, render: function() { var t; return (t = a.DOM.div)({ className: "lc-picker" }, this.renderBody()) } }), e.exports = s }, { "../core/localization": 13, "./ClearButton": 30, "./ColorWell": 31, "./React-shim": 35, "./UndoRedoButtons": 38, "./ZoomButtons": 39 }],
        35: [function(t, e, n) { var i; try { i = t("react") } catch (r) { i = window.React } if (null == i) throw "Can't find React";
            e.exports = i }, { react: "react" }],
        36: [function(t, e, n) { var i; try { i = t("react-dom") } catch (r) { i = window.ReactDOM } if (null == i) try { i = t("react") } catch (o) { i = window.React }
            if (null == i) throw "Can't find ReactDOM";
            e.exports = i }, { react: "react", "react-dom": "react-dom" }],
        37: [function(t, e, n) { var i, r, o;
            i = t("./React-shim"), o = t("../reactGUI/createSetStateOnEventMixin"), r = t("../core/util").classSet, e.exports = i.createClass({ displayName: "StrokeWidthPicker", getState: function(t) { return null == t && (t = this.props.tool), { strokeWidth: t.strokeWidth } }, getInitialState: function() { return this.getState() }, mixins: [o("toolDidUpdateOptions")], componentWillReceiveProps: function(t) { return this.setState(this.getState(t.tool)) }, render: function() { var t, e, n, o, s, a, h; return o = i.DOM, h = o.ul, n = o.li, a = o.svg, t = o.circle, e = o.div, s = this.props.lc.opts.strokeWidths, e({}, s.map(function(n) { return function(i, o) { var s, h; return s = r({ "square-toolbar-button": !0, selected: i === n.state.strokeWidth }), h = 28, e({ key: i }, e({ className: s, onClick: function() { return n.props.lc.trigger("setStrokeWidth", i) } }, a({ width: h - 2, height: h - 2, viewPort: "0 0 " + i + " " + i, version: "1.1", xmlns: "http://www.w3.org/2000/svg" }, t({ cx: Math.ceil(h / 2 - 1), cy: Math.ceil(h / 2 - 1), r: i / 2 })))) } }(this))) } }) }, { "../core/util": 19, "../reactGUI/createSetStateOnEventMixin": 40, "./React-shim": 35 }],
        38: [function(t, e, n) { var i, r, o, s, a, h, l;
            i = t("./React-shim"), h = t("./createSetStateOnEventMixin"), a = t("../core/util").classSet, l = function(t) { return i.createClass({ displayName: "undo" === t ? "UndoButton" : "RedoButton", getState: function() { return { isEnabled: function() { switch (!1) {
                                    case "undo" !== t:
                                        return this.props.lc.canUndo();
                                    case "redo" !== t:
                                        return this.props.lc.canRedo() } }.call(this) } }, getInitialState: function() { return this.getState() }, mixins: [h("drawingChange")], render: function() { var e, n, r, o, s, h, l, c, u, p, d; return l = i.DOM, n = l.div, o = l.img, c = this.props, s = c.lc, r = c.imageURLPrefix, d = "undo" === t ? "Undo" : "Redo", e = "lc-" + t + " " + a({ "toolbar-button": !0, "thin-button": !0, disabled: !this.state.isEnabled }), h = function() { switch (!1) {
                                case !!this.state.isEnabled:
                                    return function() {};
                                case "undo" !== t:
                                    return function() { return s.undo() };
                                case "redo" !== t:
                                    return function() { return s.redo() } } }.call(this), u = r + "/" + t + ".png", p = { backgroundImage: "url(" + u + ")" }, n({ className: e, onClick: h, title: d, style: p }) } }) }, o = i.createFactory(l("undo")), r = i.createFactory(l("redo")), s = i.createClass({ displayName: "UndoRedoButtons", render: function() { var t; return (t = i.DOM.div)({ className: "lc-undo-redo" }, o(this.props), r(this.props)) } }), e.exports = s }, { "../core/util": 19, "./React-shim": 35, "./createSetStateOnEventMixin": 40 }],
        39: [function(t, e, n) { var i, r, o, s, a, h, l;
            i = t("./React-shim"), h = t("./createSetStateOnEventMixin"), a = t("../core/util").classSet, l = function(t) { return i.createClass({ displayName: "in" === t ? "ZoomInButton" : "ZoomOutButton", getState: function() { return { isEnabled: function() { switch (!1) {
                                    case "in" !== t:
                                ...
                                case !!this.state.isEnabled:
                                    return function() {};
                                case "in" !== t:
                                    return function() { return s.zoom(s.config.zoomStep) };
                                case "out" !== t:
                                    return function() { return s.zoom(-s.config.zoomStep) } } }.call(this), u = r + "/zoom-" + t + ".png", p = { backgroundImage: "url(" + u + ")" }, n({ className: e, onClick: h, title: d, style: p }) } }) }, s = i.createFactory(l("out")), o = i.createFactory(l("in")), r = i.createClass({ displayName: "ZoomButtons", render: function() { var t; return (t = i.DOM.div)({ className: "lc-zoom" }, s(this.props), o(this.props)) } }), e.exports = r }, { "../core/util": 19, "./React-shim": 35, "./createSetStateOnEventMixin": 40 }],
        40: [function(t, e, n) { var i, r;
            i = t("./React-shim"), e.exports = r = function(t) { return { componentDidMount: function() { return this.unsubscribe = this.props.lc.on(t, function(t) { return function() { return t.setState(t.getState()) } }(this)) }, componentWillUnmount: function() { return this.unsubscribe() } } } }, { "./React-shim": 35 }],
        41: [function(t, e, n) { var i, r, o, s;
            i = t("./React-shim"), o = t("../core/util").classSet, r = t("../core/localization")._, s = function(t) { var e, n; return e = t.name, n = t.iconName, i.createFactory(i.createClass({ displayName: e, getDefaultProps: function() { return { isSelected: !1, lc: null } }, componentWillMount: function() { return this.props.isSelected ? this.props.lc.setTool(t) : void 0 }, render: function() { var s, a, h, l, c, u, p, d, f; return p = i.DOM, a = p.div, l = p.img, d = this.props, h = d.imageURLPrefix, c = d.isSelected, u = d.onSelect, s = o({ "lc-pick-tool": !0, "toolbar-button": !0, "thin-button": !0, selected: c }), f = h + "/" + n + ".png", a({ className: s, style: { backgroundImage: "url(" + f + ")" }, onClick: function() { return u(t) }, title: r(e) }) } })) }, e.exports = s }, { "../core/localization": 13, "../core/util": 19, "./React-shim": 35 }],
        42: [function(t, e, n) { "use strict";

            function i(t, e) { var n = t.className,
                    i = new s(e); return o.render(r.createElement(a, { lc: i }), t), i.teardown = function() { i._teardown(); for (var e = 0; e < t.children.length; e++) t.removeChild(t.children[e]);
                    t.className = n }, i } var r = t("./React-shim"),
                o = t("./ReactDOM-shim"),
                s = t("../core/LiterallyCanvas"),
                a = t("./LiterallyCanvas");
            e.exports = i }, { "../core/LiterallyCanvas": 5, "./LiterallyCanvas": 32, "./React-shim": 35, "./ReactDOM-shim": 36 }],
        43: [function(t, e, n) { var i, r, o, s = function(t, e) {

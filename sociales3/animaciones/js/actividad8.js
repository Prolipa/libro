...
var resp_cor_len3_act8_p13 = {
    inicio : ["inicio","img/i2_p13_act8.png"],
    desarrollo : ["desarrollo","img/i3_p13_act8.png"],
    final : ["final","img/i1_p13_act8.png"] 
}
var cajas = document.getElementsByClassName('cajas');
var loadImg = ['img/i1_p13_act8.png','img/i2_p13_act8.png','img/i3_p13_act8.png'];
var loadTxt = ['INICIO','DESARROLLO','FINAL'];
...
function contarRespCorrectaDnD(){
    ...
    for(var i=0; i<Object.values(resp_cor_len3_act8_p13).length; i++){
        for(j=0; j<Object.values(cont_resp_cor).length;j++){
            if(JSON.stringify(Object.values(resp_cor_len3_act8_p13)[i]) === JSON.stringify(Object.values(cont_resp_cor)[j])){
